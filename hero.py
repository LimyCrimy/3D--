...
class Hero():
    ...
    def accept_events(self):
        ...
        base.accept(key_back, self.forward)
        base.accept(key_back + '-repeat', self.forward)
        base.accept(key_forward, self.back)
        base.accept(key_forward + '-repeat', self.back)
        ...
        base.accept(key_blyat, self.land.SaveMap)
        base.accept(key_suka, self.land.loadMap)
